<?php
    foreach ($loaidm_byid as $key => $value) {
    //     # code...
        ...
        <div class="breadcrumb-shop"><div class="container">
            <div class="breadcrumb-list  ">
                <ol class="breadcrumb breadcrumb-arrows" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                        <a href="<?php echo BASE_URL?>danhmuc/danhmucsanpham/<?php echo $value['iddm']?>" target="_self" itemprop="item">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                        <a href="<?php echo BASE_URL?>danhmuc/loaidanhmucsanpham/<?php echo $value['idloaidm']?>" target="_self" itemprop="item">
                            <span itemprop="name" class="text-capitalize"><?php echo $value['tenloaidm']?></span>
                        </a>
