<div class="col">
    ...
    <form class="form-horizontal mt-3" action="<?php echo BASE_URL?>danhmuc/update_loaidanhmuc/<?php echo $value['idloaidm'];?>" method="post">
        <div class="form-group row">
            <label for="text" class="col-md-3 control-label">Tên loại danh mục</label>
            <div class="col-md-9">
                <input name="tenloaidm" type="text" class="form-control" id="inputEmail3" value="<?php echo $value['tenloaidm'];?>">
                <?php
                    }
                ?>
            </div>
